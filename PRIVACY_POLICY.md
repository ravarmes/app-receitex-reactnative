...
O aplicativo não coleta automaticamente informações sobre você ou seu dispositivo além daquelas necessárias para o funcionamento básico do aplicativo.
...
- Gerar estatísticas anônimas sobre o uso do aplicativo
...
Não compartilhamos, vendemos ou transferimos suas informações pessoais a terceiros, exceto quando exigido por lei.

## Segurança dos Dados

Implementamos medidas técnicas e organizacionais para proteger suas informações contra acesso não autorizado, perda acidental ou alteração.

## Direitos do Usuário

Você tem direito a:

- Acessar, corrigir ou excluir suas informações pessoais a qualquer momento
